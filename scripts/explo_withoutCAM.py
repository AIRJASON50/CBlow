...
#     ctrl_process.start()
    ...
    # 创建网格
    surface_grid_map = SurfaceGridMap(fixed_region, grid_size=seebelow_const.PALP_CONST.grid_size)
    if debug:
        # 可视化网格（可选）
        pcd = o3d.geometry.PointCloud()
        pcd.points = o3d.utility.Vector3dVector(surface_grid_map.grid)
